 ...
 */
@BindingMethods(
      @BindingMethod(type = TintedBackgroudRelativeLayout.class, attribute =
            "tbvg_drawableTintList", method = "setBackgroundDrawableColor")
)
public class TintedBackgroudRelativeLayout extends RelativeLayout {

    private ColorStateList mDrawableColor;

    public TintedBackgroudRelativeLayout(final Context context) {
        this(context, null);
    }
    ...
    public TintedBackgroudRelativeLayout(final Context context,
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(
              context, attrs, com.neatier.widgets.R.styleable.TintedBackgroundViewGroup,
              defStyleAttr, 0);
        mDrawableColor =
              createDefaultColorStateList(a,
                                          com.neatier.widgets.R.styleable
                                                .TintedBackgroundViewGroup_tbvg_drawableTintList,
                                          android.R.attr.textColorPrimary,
                                          com.neatier.widgets.R.color.colorTextPrimary);
        a.recycle();
    }
    ...
    @Override protected void drawableStateChanged() {
        ...
        int defaultColor =
              ContextCompat.getColor(getContext(), com.neatier.widgets.R.color.colorPrimary);
        this.setBackground(
