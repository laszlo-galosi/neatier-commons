 ...
 */
@BindingMethods(
      @BindingMethod(type = TintedBackgroudFrameLayout.class, attribute = "tbvg_drawableTintList",
                     method = "setBackgroundDrawableColor")
)
public class TintedBackgroudFrameLayout extends FrameLayout {

    private ColorStateList mDrawableColor;

    public TintedBackgroudFrameLayout(final Context context) {
        this(context, null);
    }
