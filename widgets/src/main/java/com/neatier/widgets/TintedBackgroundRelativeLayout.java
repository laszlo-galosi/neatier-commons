...
/**
 * A {@link RelativeLayout} sub class with tinted background.
 *
 * @author László Gálosi
 * @since 14/05/17
 */
@BindingMethods(
        @BindingMethod(type = TintedBackgroundRelativeLayout.class, attribute =
            "tbvg_drawableTintList", method = "setBackgroundDrawableColor")
)
public class TintedBackgroundRelativeLayout extends RelativeLayout {
